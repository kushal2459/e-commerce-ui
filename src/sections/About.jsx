...
const About = () => {
  return (
    <>
    <div className='text-center flex flex-col justify-center items-center mt-10' id='about'>
    ...
    <div className='flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex justify-center md:justify-end'>
            <img src={about_img} alt="about_img" width={3000} className='w-full md:w-[1700px] h-auto'/>
        </div>
    </div>
    </>
  )
